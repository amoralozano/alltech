...
export default function Carusel2() {
  return (
    <div className="bg-black mb-[-70px] mt-[150px] md:mt-0">
      <div className="container w-full mx-auto mb-[40px] md:mt-[-30px] lg:mt-[-90px] bg-black">
            ...
            <div className="w-full relative flex items-center justify-center">
                  ...
                  >
                    <Slide index={0}>
                      <div className="flex flex-shrink-0 shadow-xl relative w-[300px] h-[420px] sm:w-auto">
                        ...
                        />
                        <div className="bg-gradient-to-r from-pink-300 via-purple-400 to-purple-500 absolute inset-x-0 bottom-0 w-full h-[60px] p-6 rounded-b-md">
                          <h3 className="text-xl text-center lg:text-2xl font-extrabold leading-5 lg:leading-6 text-transparent bg-clip-text bg-gradient-to-br from-purple-700 to-gray-900 mt-[-5px]">
                            PS5 Color Controllers
                          </h3>
                        </div>
                      </div>
              ...
              >
                <img
                  src={assets.backarrow}
                  alt="right"
                  className="w-[15px] h-[40px] rotate-180"
                />
              </ButtonNext>
            </div>
          </CarouselProvider>
